...
import cn.fivezha.api.dto.AccountDTO;
import cn.fivezha.api.dto.AccountLoginDTO;
import cn.fivezha.api.dto.AccountResponseDTO;
...
import cn.fivezha.api.service.impl.UserDetailsServiceImpl;
import cn.fivezha.api.util.JsonUtils;
...
public class AccountController {
    ...
    public Result register(
        ...
        return ResultGenerator.genOkResult(new AccountResponseDTO(accountDTO.getName(), token, accountDTO.getEmail(), "https://shiji-1258573901.cos.ap-chengdu.myqcloud.com/avatar.png", 20));
    }
    ...
    public Result login(
        ...
        return ResultGenerator.genOkResult(new AccountResponseDTO(name, token, accountDO.getEmail(), accountDO.getAvatar(), accountDO.getTodayWords()));
    }
